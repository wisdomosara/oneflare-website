  ...
  return (
    <section className="py-12 mb-0" ref={ref}>
      <div className="container mx-auto">
        <div
          className={`relative overflow-hidden rounded-xl bg-gradient-to-r from-primary to-blue-600 p-12 text-center shadow-xl transition-all duration-700 md:p-16 ${isInView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}
        >
          {/* Decorative elements */}
          ...
          <div className="relative">
            ...
            <div className="flex flex-col items-center justify-center space-y-4 sm:flex-row sm:space-x-6 sm:space-y-0">
              <Button
                size="lg"
                variant="secondary"
                className="min-w-[160px] bg-white text-primary hover:bg-white/90 px-8 py-6 text-lg"
                asChild
              >
              ...
              <Button
                size="lg"
                variant="outline"
                className="min-w-[160px] border-white text-primary hover:text-primary px-8 py-6 text-lg"
                asChild
              >
